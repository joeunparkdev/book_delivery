...
export class StoresService {
    ...
    // createStore
    createStore = async(userId, imageUrl, name, price, address, description, status) => {
        const createdStore = await this.storeRepository.createStore(
            userId, imageUrl, name, price, address, description, status
        );
    ...
    // updateStore
    updateStore = async(bookstoreId, imageUrl, name, price, address, description, status, updatedAt, userId) => {
        try {
            const existingStore = await this.storeRepository.findStoreById(bookstoreId);
